...
export const Home = () =>
{
  ...
  return (
          ...
          <div className="infocard">
            <LittleCard imgsrc={wheel}p1="Liability insurance to improve your security" p2="Travel with tranquility with us. We offer civil liability insurance for all our vehicle, and security options as child seat to accommodate your entire family."/>
            <LittleCard imgsrc={mil}p1="Unlimited mileage on all vehicles" p2="Enjoy your trip without thinking how many kilometers you can drive, because you have unlimited mileage to have a sastisfactory experience."/>
